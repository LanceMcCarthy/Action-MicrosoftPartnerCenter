...
const partnerCenter = __importStar(__webpack_require__(882));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mandatoryUpdate = core.getInput('mandatory_update').toLowerCase() == 'true';
        ...
        // 1. Authenticate
        const authResult = yield partnerCenter.authenticate(tenantId, clientId, clientSecret);
        const auth = 'Bearer ' + authResult.access_token;
        // Get the application's info
        const appInfo = yield partnerCenter.getAppResourceInfo(auth, appId);
        ...
        if (deletePendingSubmissions && pendingSubmission) {
            yield partnerCenter.deleteSubmission(auth, appInfo.id, appInfo.pendingApplicationSubmission.id);
        }
        // Create a new submission
        const createSubResult = yield partnerCenter.createAppSubmission(auth, appId);
        const submissionId = createSubResult.id;
        // TODO need to figure out how to attach package file to submission.
        // Commit
        const commitResult = yield partnerCenter.commitSubmission(auth, appId, submissionId);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.deleteSubmission = exports.getSubmissionStatus = exports.getSubmission = exports.commitSubmission = exports.getAppResourceInfo = exports.createAppSubmission = exports.authenticate = void 0;
const got_1 = __importDefault(__webpack_require__(77));
const querystring_1 = __importDefault(__webpack_require__(191));
const converters_1 = __webpack_require__(187);
...
function authenticate(tenantId, clientId, clientSecret) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.createAppSubmission = createAppSubmission;
function getAppResourceInfo(bearerToken, appId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
exports.getAppResourceInfo = getAppResourceInfo;
// https://docs.microsoft.com/en-us/windows/uwp/monetize/commit-an-app-submission
function commitSubmission(bearerToken, appId, submissionId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function getSubmission(bearerToken, appId, submissionId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function getSubmissionStatus(bearerToken, appId, submissionId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function deleteSubmission(bearerToken, appId, submissionId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const requestUrl = `"https://manage.devcenter.microsoft.com/v1.0/my/applications/${appId}/submissions/${submissionId}"`;
            let response = yield got_1.default(requestUrl, {
